...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - Analyze Social Media</title>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="http://<?php echo  base_url('assets/css/ace.min.css') ; ?>" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="http://<?php echo  base_url() ; ?>assets/css/ace-part2.min.css" />
		<![endif]-->
...
var city=document.forms["registerForm"]["city"].value;
		    ...
		    if (x != y) {
				...
				else if(name =="" || phone =="" || country =="" || city ==""  ){
					alert("You didnt fill all areas  ");
					return false ;
				}
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Analyze </span>
									<span class="white" id="id-text2">Social Media</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; King Saud University</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<h5 ><?php if (isset($msg)){echo $msg ;} ?>
											</h5>
											<div class="space-6"></div>

											<form action="http://<?php echo base_url();  ?>index.php/user/checkLogin" method="post">
												<fieldset>
